...
//	/**
//	 * 痍④툒 �긽�뭹 肄붾뱶濡� 寃��깋�븯湲� (-> 諛쒖＜�븯湲� �쐞�빐)
//	 * */
//	@Override
//	public Sku selectBySkuId(String skuId) throws SQLException {
//		Connection con = null;
//		PreparedStatement ps = null;
//		ResultSet rs = null;
//		Sku sku = null;
//		String sql = proFile.getProperty("sku.selectBySkuId");
//		try {
//			con = DbUtil.getConnection();
//			ps = con.prepareStatement(sql);
...
//				Sku sku = skuDao.selectBySkuId(ibline.getGoodsId());
//						
...
//	@Override
//	public int[] ibLineUpdate(Connection con, List<IbLine> ibLineList) throws SQLException {
//		PreparedStatement ps = null;
//		String sql = proFile.getProperty("ibline.insert");
//		int result [] = null;
//		try {
...
//			// ib line sql �떎�뻾 愿��젴
//			
//			for (IbLine ibLine : ibLineList) {
//				// 諛쒖＜ �뭹紐⑹씠 goods�뿉 �엳�뒗吏� �솗�씤 & �뾾�쑝硫� stock 0�쑝濡� �씪�떒 異붽�
//				Goods goods = goodsDao.goodsSelectById(ibLine.getGoodsId());
//				Sku sku = skuDao.selectSkuById(ibLine.getGoodsId());
//			
//				if (goods == null) {
//					
//					Goods newGoods = new Goods(sku.getSkuId(), sku.getSkuName(), 0, (int)(2*1.3*(sku.getSkuPrice())));
//					goodsDao.goodsInsert(goods);
//				}
//				// 諛쒖＜ �빆紐⑹뿉 ���빐�꽌 ib_line �뱾�쓣 李몄“�빐 stock_qty�뿉 �뼹�삩 �닔�웾留뚰겮 異붽�
//				goodsDao.goodsUpdate(ibLine.getGoodsId(), ibLine.getIbQty());
//				
//				//諛쒖＜ �긽�꽭 �벑濡앺븯湲�
