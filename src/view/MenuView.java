...
public class MenuView {
	...
	public static void printInputOrder(String cusId) {
		...
		System.out.println(
			"―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
		System.out.println("원하는 아이스크림 종류를 선택하세요 》");
		int menu = Integer.parseInt(sc.nextLine());
		while (true) {
			switch (menu) {
	...
	public static void printselectOrders(String cusId) {
		...
		System.out.println("―――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
		System.out.println("아이스크림 주문은 1번을 눌러주세요 》 ");
		int menu = Integer.parseInt(sc.nextLine());
		//while(true) {
		switch (menu) {
			case 1:
	...
	public static void printInsertOrders(String cusId) {
		...
		while (true) {
			...
			System.out.println(" 【  Pos of Fourth  】 ");
			System.out.println("―――――――――――――――――――――――――――――――――――――――――――――");
			System.out.println("아이스크림 상품코드 입력하기(품목 등록을 중단하시려면 \"END\"를 입력해주세요)  》 ");
			String goodsId = sc.nextLine();
			if (goodsId.toLowerCase().equals("end")) {
				break;
			}
			System.out.println("아이스크림 수 입력하기  》 ");
	 ...
	 * 1. 장바구니 담기 2.뒤로가기
	 * */
    /*public static void printInputOrdersub() {
    	System.out.println();
    	System.out.println("―――――――――――――――――――――――――――――――――――――――――――――――――――");
        System.out.println(" 1.장바구니 담기 |  2. 다른 종류 선택 |  3. 나가기 ");
    	System.out.println("―――――――――――――――――――――――――――――――――――――――――――――――――――");
    ...
    /*public static void putCart(String id) {
		System.out.println("-- 구매하실 상품과 수량을 선택해주세요 --");
		System.out.print("상품번호 (goodsId): ");
		String goodsId = sc.nextLine();
		System.out.print("수량 : ");
		int qty = Integer.parseInt(sc.nextLine());
		
		CartController cc = new CartController();
		CartController.putCart(cusId, goodsId, qty);
		//카트에 담고, 다 담으면 주문 Order로 옮긴다
	}*/
	...
	public static void GoodsAdminMenu() {
		...
		while (true) {
			...
			switch (menu) {
				case 1: // 상품 등록
					System.out.println("등록할 상품코드를 입력해주세요");
					goodsId = sc.nextLine();

					System.out.println("등록할 상품이름을 입력해주세요");
					goodsName = sc.nextLine();

					System.out.println("등록할 상품의 수량을 입력해주세요");
